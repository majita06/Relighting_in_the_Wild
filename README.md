...
2. Download our [two pre-trained models](https://drive.google.com/drive/folders/1ezvJJy9DcsgCn7XGfHNqVlmWQe7fhGab?usp=sharing) and put "model_1st.pth" and "model_2nd.pth" into the "trained_models" directory.

...
python3 remove_flicker.py -i $1 -o ./demo/relighting_video/flicker_reduction/${video_name}+${light_name} -p ./demo/relighting_video/2nd/${video_name}+${light_name} -l ./demo/relighting_video/1st/${video_name}+${light_name} --gpu 0

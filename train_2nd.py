...
parser.add_argument('--test_dir', '-t', default='./data/test_human_2nd', help='Directory for test input images')
...
for epoch in range(max_epochs):
    ...
    for i in range(N_train_paths):
        ...
        res3 = torch.cat([res,res,res],1)
        ##########################################
        result = rend_1st + res3
